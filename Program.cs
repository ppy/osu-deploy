        ...
        public static void Main(string[] args)
        {
            ...
            switch (RuntimeInfo.OS)
            {
                ...
                case RuntimeInfo.Platform.Linux:
                    ...
                    runCommand($"{stagingPath}/appimagetool.AppImage", $"\"{stagingPath}/osu!.AppDir\" -u \"gh-releases-zsync|ppy|osu|latest|osu!-*x86_64.AppImage.zsync\" \"{Path.Combine(Environment.CurrentDirectory, "releases")}/osu!-x86_64.AppImage\"", false);
